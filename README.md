...
For detailed instructions, see our [official guides](https://github.com/community-scripts/ProxmoxVE/blob/main/USER_SUBMITTED_GUIDES.md).
...
This project honors the legacy of [tteck](https://github.com/tteck). His work laid the foundation for this community-driven initiative, and we are committed to carrying it forward in his memory.
