...
cat <<EOF >/etc/postgresql/17/nodejs_22/pg_hba.conf
...
cat <<EOF >/etc/postgresql/17/nodejs_22/postgresql.conf
# -----------------------------
...
hba_file = '/etc/postgresql/17/nodejs_22/pg_hba.conf'     
ident_file = '/etc/postgresql/17/nodejs_22/pg_ident.conf'   
